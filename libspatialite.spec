...
%prep
%setup -q -n libspatialite-5.0.0
cd %{_builddir}/libspatialite-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598294050
...
cp %{_builddir}/libspatialite-5.0.0/COPYING %{buildroot}/usr/share/package-licenses/libspatialite/fac7e08b00d48464e5cff0180701395569184413
cp %{_builddir}/libspatialite-5.0.0/src/control_points/COPYING %{buildroot}/usr/share/package-licenses/libspatialite/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
